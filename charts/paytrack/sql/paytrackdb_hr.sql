...
CREATE TABLE `hr` (
  ...
  PRIMARY KEY (`userid`),
  KEY `deptid` (`deptid`),
  CONSTRAINT `hr_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`userid`) ON DELETE CASCADE,
  CONSTRAINT `hr_ibfk_2` FOREIGN KEY (`deptid`) REFERENCES `department` (`deptid`) ON DELETE CASCADE
